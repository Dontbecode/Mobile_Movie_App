      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
          ...
          <View className='flex-col items-start justify-center mt-5 px-5 '>
            ...
            <View className='flex-row items-center gap-x-1 mt-2 '>
              ...
              <Text className='text-light-200 tet-sm'>{movie?.runtime}</Text>
            </View>
            ...
            <View className='flex flex-row justify-between w-1/2'>
              <MovieInfo label="Budget" value={movie?.budget !== undefined ? `$${(movie.budget / 1_000_000).toFixed(2)} million` : 'N/A'} />
              <View style={{ width: 16 }} />
              <MovieInfo label="Revenue" value={movie?.revenue !== undefined ? `$${(Math.round(movie.revenue) / 1_000_000).toFixed(2)} million` : 'N/A'} />
            </View>
